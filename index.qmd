---
title: "How to Estimate the Burden of Disease Caused by Respiratory Viruses from Time Series Data"
author:
  - name: "Daniel M. Weinberger"
    affiliations:
      - ref: epi
  - name: "Joshua L. Warren"
    affiliations:
      - ref: biostat
affiliations:
  - id: epi
    name: "Department of Epidemiology of Microbial Diseases, Yale University, New Haven, CT"
  - id: biostat
    name: "Department of Biostatistics, Yale University, New Haven, CT"
date: today
---

::: {.callout-note title="Abstract" icon="false"}
...
Unfortunately, estimating the burden of disease directly from routinely collected data is not reliable. Most individuals seeking healthcare for an infection are not tested for a specific microbe. As a result, the number of cases of disease caused by individual pathogens and captured by surveillance systems often represents a substantial undercount [[1](https://pubmed.ncbi.nlm.nih.gov/34244735/),[2](https://pubmed.ncbi.nlm.nih.gov/32710751/),[3](https://pubmed.ncbi.nlm.nih.gov/28911764/),[4](https://pubmed.ncbi.nlm.nih.gov/36963040/)]. For example, with respiratory syncytial virus (RSV), many of the children presenting to the hospital or emergency department with respiratory symptoms during the winter virus season will get tested for RSV, and those children's illnesses will be correctly attributed to the virus (**Figure 1**). In adults, however, testing for RSV is much less common. Even when tested, the amount of the virus tends to be lower in adults, reducing the sensitivity of the tests and further leading to underdetection of infected individuals [[5](https://pubmed.ncbi.nlm.nih.gov/36661222/),[6](https://pubmed.ncbi.nlm.nih.gov/40250971/)]. As a result, fewer than 5% of people who actually have an illness caused by RSV have the virus correctly recorded as a contributing cause in their clinical records (**Figure 1**, [[1](https://pubmed.ncbi.nlm.nih.gov/34244735/),[7](https://pubmed.ncbi.nlm.nih.gov/15858184/),[8](https://pubmed.ncbi.nlm.nih.gov/36707466/)]). Instead, unspecified viral pneumonia or respiratory infection could be recorded, contributing to underestimation of disease burden [[9](https://pubmed.ncbi.nlm.nih.gov/31206246/),[10](https://pubmed.ncbi.nlm.nih.gov/37747825/)]. This underdetection has been confirmed in a number of settings and using distinct methodologies [[1](https://pubmed.ncbi.nlm.nih.gov/34244735/),[11](https://pubmed.ncbi.nlm.nih.gov/36280891/),[12](https://pubmed.ncbi.nlm.nih.gov/40810757/),[13](https://pubmed.ncbi.nlm.nih.gov/41513868/),[14](https://pubmed.ncbi.nlm.nih.gov/40289699/),[15](https://pubmed.ncbi.nlm.nih.gov/38319540/)].

![](figures/fig1-age-undercounting.png){fig-align="center" width="85%"}
...
![](figures/fig2-pneumonia-flu-timeseries.png){fig-align="center" width="90%"}
...
$$
\begin{aligned}
& \text{Expected pneumonia cases at week } t:\\
& \quad  E(Y_t) = \beta_0 + \beta_1 \cdot \text{Trend}_t + \beta_2 \cdot \text{Seasonality}_t + \beta_3 \cdot \text{Influenza}_t + \text{Noise}_t
\end{aligned}
$$
:::

![](figures/fig3-decomposition.png){fig-align="center" width="80%"}
...
$$
\begin{aligned}
& \text{Expected pneumonia cases at week } t \text{ without influenza:} \\
& \quad E(Y_{0t}) = \beta_0 + \beta_1 \cdot \text{Trend}_t + \beta_2 \cdot \text{Seasonality}_t + \beta_3 \cdot 0 + \text{Noise}_t
\end{aligned}
$$
:::
...
1.  [Branche AR, Saiman L, Walsh EE, Falsey AR, Sieling WD, Greendyke W, et al. Incidence of Respiratory Syncytial Virus Infection Among Hospitalized Adults, 2017-2020. Clin Infect Dis. 2022;74: 1004–1011.](https://pubmed.ncbi.nlm.nih.gov/34244735/)
2.  [Ebruke BE, Deloria Knoll M, Haddix M, Zaman SMA, Prosperi C, Feikin DR, et al. The Etiology of Pneumonia From Analysis of Lung Aspirate and Pleural Fluid Samples: Findings From the Pneumonia Etiology Research for Child Health (PERCH) Study. Clin Infect Dis. 2021;73: e3788–e3796.](https://pubmed.ncbi.nlm.nih.gov/32710751/)
3.  [Scheltema NM, Gentile A, Lucion F, Nokes DJ, Munywoki PK, Madhi SA, et al. Global respiratory syncytial virus-associated mortality in young children (RSV GOLD): a retrospective case series. Lancet Glob Health. 2017;5: e984–e991.](https://pubmed.ncbi.nlm.nih.gov/28911764/)
4.  [Mahtab S, Madhi SA, Baillie VL, Els T, Thwala BN, Onyango D, et al. Causes of death identified in neonates enrolled through Child Health and Mortality Prevention Surveillance (CHAMPS), December 2016 - December 2021. PLOS Glob Public Health. 2023;3: e0001612.](https://pubmed.ncbi.nlm.nih.gov/36963040/)
5.  [Onwuchekwa C, Moreo LM, Menon S, Machado B, Curcio D, Kalina W, et al. Underascertainment of Respiratory Syncytial Virus Infection in Adults Due to Diagnostic Testing Limitations: A Systematic Literature Review and Meta-analysis. J Infect Dis. 2023;228: 173–184.](https://pubmed.ncbi.nlm.nih.gov/36661222/)
6.  [Begier E, Aliabadi N, Ramirez JA, McGeer A, Liu Q, Carrico R, et al. Detection by Nasopharyngeal Swabs Alone Underestimates Respiratory Syncytial Virus-Related Hospitalization Incidence in Adults: The Multispecimen Study's Final Analysis. J Infect Dis. 2025;232: e126–e136.](https://pubmed.ncbi.nlm.nih.gov/40250971/)
7.  [Falsey AR, Hennessey PA, Formica MA, Cox C, Walsh EE. Respiratory syncytial virus infection in elderly and high-risk adults. N Engl J Med. 2005;352: 1749–1759.](https://pubmed.ncbi.nlm.nih.gov/15858184/)
8.  [Rozenbaum MH, Judy J, Tran D, Yacisin K, Kurosky SK, Begier E. Low Levels of RSV Testing Among Adults Hospitalized for Lower Respiratory Tract Infection in the United States. Infect Dis Ther. 2023;12: 677–685.](https://pubmed.ncbi.nlm.nih.gov/36707466/)
9.  [Cai W, Tolksdorf K, Hirve S, Schuler E, Zhang W, Haas W, et al. Evaluation of using ICD-10 code data for respiratory syncytial virus surveillance. Influenza Other Respi Viruses. 2020;14: 630–637.](https://pubmed.ncbi.nlm.nih.gov/31206246/)
10. [Egeskov-Cavling AM, Johannesen CK, Lindegaard B, Fischer TK. Underreporting and Misclassification of Respiratory Syncytial Virus-Coded Hospitalization Among Adults in Denmark Between 2015-2016 and 2017-2018. The Journal of infectious diseases. 2024;229. doi:10.1093/infdis/jiad415](https://pubmed.ncbi.nlm.nih.gov/37747825/)
11. [Zheng Z, Warren JL, Shapiro ED, Pitzer VE, Weinberger DM. Estimated incidence of respiratory hospitalizations attributable to RSV infections across age and socioeconomic groups. Pneumonia (Nathan). 2022;14: 6.](https://pubmed.ncbi.nlm.nih.gov/36280891/)
12. [Casas M, Liang C, Molden T, Bruyndonckx R, Esnaola M, Basu S, et al. Estimated Incidence of Hospitalisations and Deaths Attributable to Respiratory Syncytial Virus Infections in Adults in Norway between 2010 and 2019: A Time-Series Modelling Study. J Epidemiol Glob Health. 2025;15: 107.](https://pubmed.ncbi.nlm.nih.gov/40810757/)
13. [Bruyndonckx R, Polkowska-Kramek A, Liang C, Kosunen M, Hätinen O-P, Esnaola M, et al. Estimated Incidence of All-Cause Respiratory Hospitalizations and Deaths Attributable to Respiratory Syncytial Virus Infections in Adults in Finland between 2011 and 2019: A Retrospective Database Study. J Epidemiol Glob Health. 2026;16: 7.](https://pubmed.ncbi.nlm.nih.gov/41513868/)
14. [Liang C, Polkowska-Kramek A, Lade C, Bayer LJ, Bruyndonckx R, Huebbe B, et al. Estimated Incidence Rate of Specific Types of Cardiovascular and Respiratory Hospitalizations Attributable to Respiratory Syncytial Virus Among Adults in Germany Between 2015 and 2019. Influenza Other Respir Viruses. 2025;19: e70097.](https://pubmed.ncbi.nlm.nih.gov/40289699/)
15. [Haeberer M, Bruyndonckx R, Polkowska-Kramek A, Torres A, Liang C, Nuttens C, et al. Estimated Respiratory Syncytial Virus-Related Hospitalizations and Deaths Among Children and Adults in Spain, 2016-2019. Infect Dis Ther. 2024;13: 463–480.](https://pubmed.ncbi.nlm.nih.gov/38319540/)
16. [O'Brien KL, Baggett HC, Brooks WA, Feikin DR, Hammitt LL, Higdon MM, et al. Causes of severe pneumonia requiring hospital admission in children without HIV infection from Africa and Asia: the PERCH multi-country case-control study. Lancet. 2019;394: 757–779.](https://pubmed.ncbi.nlm.nih.gov/31257127/)
17. [Antillón M, Warren JL, Crawford FW, Weinberger DM, Kürüm E, Pak GD, et al. The burden of typhoid fever in low-and middle-income countries: A meta-regression approach. PLoS Negl Trop Dis. 2017;11: e0005376.](https://pubmed.ncbi.nlm.nih.gov/28241011/)
18. [Phillips MT, Meiring JE, Voysey M, Warren JL, Baker S, Basnyat B, et al. A Bayesian approach for estimating typhoid fever incidence from large-scale facility-based passive surveillance data. Stat Med. 2021;40: 5853–5870.](https://pubmed.ncbi.nlm.nih.gov/34428309/)
19. [GBD 2023 Causes of Death Collaborators. Global burden of 292 causes of death in 204 countries and territories and 660 subnational locations, 1990-2023: a systematic analysis for the Global Burden of Disease Study 2023. Lancet. 2025;406: 1811–1872.](https://pubmed.ncbi.nlm.nih.gov/41092928/)
20. [Zhang T, Reeves RM, Ma S, Miao Y, Sun S, Orrico-Sánchez A, et al. Estimating the respiratory syncytial virus-associated hospitalisation burden in older adults in European countries: a systematic analysis. BMC Med. 2025;23: 453.](https://pubmed.ncbi.nlm.nih.gov/40754579/)
21. [Dushoff J, Plotkin JB, Viboud C, Earn DJD, Simonsen L. Mortality due to influenza in the United States--an annualized regression approach using multiple-cause mortality data. Am J Epidemiol. 2006;163: 181–187.](https://pubmed.ncbi.nlm.nih.gov/16319291/)
22. [Thompson WW, Shay DK, Weintraub E, Brammer L, Cox N, Anderson LJ, et al. Mortality associated with influenza and respiratory syncytial virus in the United States. JAMA. 2003;289: 179–186.](https://pubmed.ncbi.nlm.nih.gov/12517228/)
23. [Zhou H, Thompson WW, Viboud CG, Ringholz CM, Cheng P-Y, Steiner C, et al. Hospitalizations Associated With Influenza and Respiratory Syncytial Virus in the United States, 1993–2008. Clin Infect Dis. 2012;54: 1427–1436.](https://pubmed.ncbi.nlm.nih.gov/22495079/)
24. [Xu H, Pitzer VE, Warren JL, Shapiro ED, Perniciaro S, Weinberger DM. Estimating the burden of RSV- and influenza-associated ED visits, hospitalizations, ICU admissions, and deaths across age and socioeconomic groups in New York State, 2005-2019. BMC Infect Dis. 2026;26. doi:10.1186/s12879-026-12574-6](https://pubmed.ncbi.nlm.nih.gov/41606523/)
25. [McLaughlin JM, Khan F, Begier E, Swerdlow DL, Jodar L, Falsey AR. Rates of Medically Attended RSV Among US Adults: A Systematic Review and Meta-analysis. Open Forum Infect Dis. 2022;9: ofac300.](https://pubmed.ncbi.nlm.nih.gov/35873302/)
